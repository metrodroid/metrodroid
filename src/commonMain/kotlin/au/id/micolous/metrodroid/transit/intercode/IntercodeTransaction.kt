...
internal data class IntercodeTransaction(private val networkId: Int,
    ...
    companion object {
        fun parse (data: ImmutableByteArray, networkId: Int): IntercodeTransaction {
            ...
            return IntercodeTransaction(parsed.getInt(EVENT_NETWORK_ID) ?: networkId,
                    parsed)
        }
        ...
        private fun tripFields(time: (String) -> En1545FixedInteger) = En1545Container(
                ...
                En1545Bitmap(
                        ...
                        En1545FixedInteger(EVENT_JOURNEY_RUN, 16),
                        En1545FixedInteger(EVENT_VEHICLE_ID, 16),
                        En1545FixedInteger(EVENT_VEHICULE_CLASS, 8),
                        En1545FixedInteger(EVENT_LOCATION_TYPE, 5),
                        En1545FixedString(EVENT_EMPLOYEE, 240),
                        En1545FixedInteger(EVENT_LOCATION_REFERENCE, 16),
                        En1545FixedInteger(EVENT_JOURNEY_INTERCHANGES, 8),
                        En1545FixedInteger(EVENT_PERIOD_JOURNEYS, 16),
                        En1545FixedInteger(EVENT_TOTAL_JOURNEYS, 16),
                        En1545FixedInteger(EVENT_JOURNEY_DISTANCE, 16),
                        En1545FixedInteger(EVENT_PRICE_AMOUNT, 16),
                        En1545FixedInteger(EVENT_PRICE_UNIT, 16),
