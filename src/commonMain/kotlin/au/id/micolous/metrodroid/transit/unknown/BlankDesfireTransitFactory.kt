 ...
 */
object BlankDesfireTransitFactory : DesfireCardTransitFactory,
    BlankTransitFactory<DesfireCard>(R.string.blank_mfd_card) {
    ...
    override fun check(card: DesfireCard): Boolean =
        !card.appListLocked && card.applications.isEmpty()
}
