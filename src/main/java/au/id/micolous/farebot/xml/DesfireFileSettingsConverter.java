...
import au.id.micolous.farebot.card.desfire.settings.RecordDesfireFileSettings;
import au.id.micolous.farebot.card.desfire.settings.StandardDesfireFileSettings;
import au.id.micolous.farebot.card.desfire.settings.UnsupportedDesfireFileSettings;
