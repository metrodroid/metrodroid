...
package au.id.micolous.farebot.card.desfire;
...
import au.id.micolous.farebot.card.desfire.files.UnauthorizedDesfireFile;
import au.id.micolous.farebot.card.desfire.settings.DesfireFileSettings;
import au.id.micolous.farebot.card.desfire.settings.StandardDesfireFileSettings;
import au.id.micolous.farebot.card.desfire.settings.ValueDesfireFileSettings;
import au.id.micolous.farebot.fragment.DesfireCardRawDataFragment;
import au.id.micolous.farebot.transit.TransitData;
import au.id.micolous.farebot.transit.TransitIdentity;
import au.id.micolous.farebot.transit.clipper.ClipperTransitData;
import au.id.micolous.farebot.transit.hsl.HSLTransitData;
import au.id.micolous.farebot.transit.myki.MykiTransitData;
import au.id.micolous.farebot.transit.opal.OpalTransitData;
import au.id.micolous.farebot.transit.orca.OrcaTransitData;
import au.id.micolous.farebot.transit.stub.AdelaideMetrocardStubTransitData;
import au.id.micolous.farebot.transit.stub.AtHopStubTransitData;
