...
import au.id.micolous.farebot.activity.AddKeyActivity;
import au.id.micolous.farebot.provider.CardKeyProvider;
import au.id.micolous.farebot.provider.KeysTableColumns;
import au.id.micolous.farebot.util.BetterAsyncTask;
