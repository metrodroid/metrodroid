...
import au.id.micolous.farebot.card.felica.FelicaBlock;
import au.id.micolous.farebot.card.felica.FelicaCard;
import au.id.micolous.farebot.card.felica.FelicaService;
import au.id.micolous.farebot.card.felica.FelicaSystem;
import au.id.micolous.farebot.card.felica.FelicaUtils;
