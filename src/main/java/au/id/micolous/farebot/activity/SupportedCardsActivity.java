...
import au.id.micolous.farebot.transit.lax_tap.LaxTapTransitData;
...
import au.id.micolous.farebot.transit.octopus.OctopusTransitData;
import au.id.micolous.farebot.transit.opal.OpalTransitData;
import au.id.micolous.farebot.transit.ovc.OVChipTransitData;
import au.id.micolous.farebot.transit.seq_go.SeqGoTransitData;
import au.id.micolous.farebot.transit.smartrider.SmartRiderTransitData;
