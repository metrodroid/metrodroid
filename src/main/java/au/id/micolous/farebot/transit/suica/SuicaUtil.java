...
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMNS_IRUCA_STATIONCODE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMNS_STATIONCODE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_AREACODE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_COMPANYNAME;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_COMPANYNAME_EN;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_ID;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_LATITUDE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_LINECODE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_LINENAME;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_LINENAME_EN;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_LONGITUDE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_STATIONCODE;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_STATIONNAME;
import static au.id.micolous.farebot.card.felica.DBUtil.COLUMN_STATIONNAME_EN;
import static au.id.micolous.farebot.card.felica.DBUtil.TABLE_IRUCA_STATIONCODE;
import static au.id.micolous.farebot.card.felica.DBUtil.TABLE_STATIONCODE;
