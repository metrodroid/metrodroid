 ...
 */
package au.id.micolous.farebot.transit.suica;
...
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMNS_IRUCA_STATIONCODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMNS_STATIONCODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_AREACODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_COMPANYNAME;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_COMPANYNAME_EN;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_ID;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_LATITUDE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_LINECODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_LINENAME;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_LINENAME_EN;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_LONGITUDE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_STATIONCODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_STATIONNAME;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.COLUMN_STATIONNAME_EN;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.TABLE_IRUCA_STATIONCODE;
import static au.id.micolous.farebot.card.felica.FelicaDBUtil.TABLE_STATIONCODE;
