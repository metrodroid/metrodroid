...
import au.id.micolous.farebot.transit.nextfare.NextfareTransitData;
import au.id.micolous.farebot.transit.nextfare.NextfareTrip;
import au.id.micolous.farebot.transit.nextfare.record.NextfareTransactionRecord;

import java.util.Arrays;

import static au.id.micolous.farebot.transit.lax_tap.LaxTapData.AGENCY_METRO;
import static au.id.micolous.farebot.transit.lax_tap.LaxTapData.METRO_BUS_START;
import static au.id.micolous.farebot.transit.lax_tap.LaxTapData.METRO_LR_START;
