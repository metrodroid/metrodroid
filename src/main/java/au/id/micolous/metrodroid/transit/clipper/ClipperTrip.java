...
public class ClipperTrip extends Trip {
    ...
    public TimestampFull getStartTimestamp() {
        return TimestampFormatterKt.calendar2ts(ClipperTransitData.clipperTimestampToCalendar(mTimestamp));
    }

    @Override
    public TimestampFull getEndTimestamp() {
        return TimestampFormatterKt.calendar2ts(ClipperTransitData.clipperTimestampToCalendar(mExitTimestamp));
    }
