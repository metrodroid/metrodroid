...
class HSLTest : BaseInstrumentedTest() {
    ...
    fun testDemoCard() {
        ...
        assertEquals("Value ticket, 90 mins", trips[0].getAgencyName(false))
        assertEquals("Value ticket, 90 mins", trips[0].getAgencyName(true))
        ...
        assertEquals("2", trips[0].routeName)
        assertEquals(Trip.Mode.TRAIN, trips[0].mode)
        assertEquals("Zone C", trips[0].startStation!!.stationName)
        assertNull(trips[0].endStation)
        assertEquals("1074", trips[0].vehicleID)

        assertEquals("Balance refill", trips[1].getAgencyName(false))
        assertEquals("Balance refill", trips[1].getAgencyName(true))
