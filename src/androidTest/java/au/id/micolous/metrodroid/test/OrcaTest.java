...
public class OrcaTest extends AndroidTestCase {
    ...
    public void testDemoCard() {
        ...
        assertEquals("Sound Transit", trips[3].getAgencyName(true));
        assertEquals("ST", trips[3].getAgencyName(false));
        ...
        assertEquals("Washington State Ferries", trips[4].getAgencyName(true));
        assertEquals("WSF", trips[4].getAgencyName(false));
